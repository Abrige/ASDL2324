...
public class MyMultisetTest {
    ...
    public void testElementSetEmptyNotEmpty() {
        MyMultiset<Integer> m = new MyMultiset<Integer>();
        Set<Integer> ms = m.elementSet(); //ritorna in set con le chiavi
        ms.add(4);
        Set<Integer> empty = new HashSet<Integer>();
    ...
    //TEST SCRITTI DA MATTIA BRIZI
    @Test
    public void MYtestHachCodeEquals() {
        MyMultiset<Integer> m1 = new MyMultiset<Integer>();
        m1.add(3, 5);
        m1.setCount(4, 7);
        m1.remove(3);
        ...
        m3.add(3);
        m3.remove(5);
        MyMultiset<Integer> m4 = new MyMultiset<Integer>();
        m4.add(3, 2);
        m4.setCount(4, 7);
        m4.remove(5, 9);
