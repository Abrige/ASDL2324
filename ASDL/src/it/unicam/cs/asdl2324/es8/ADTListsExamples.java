...
public class ADTListsExamples {
    ...
    public static void main(String[] args) {
      ...
      System.out.println("Remove first: " + l9.print());
      ADTConsList<Integer> l10 = l8.removeAll(4);
      System.out.println("Remove All: " + l10.print());
      if (l10.find(4))
          System.out.println("4 è contenuto");
      else System.out.println("4 non è contenuto");
      ...
      System.out.println("L13: " + l13.print());
      System.out.println("L10: " + l10.print());
      ADTConsList<Integer> l14 = l13.append(l10);
      System.out.println("Append L13 e L10 (L14): " + l14.print());
      System.out.println("Reversed L14: " + l14.reverse().print());
      System.out.println("L14: " + l14.print());
      System.out.println("Aggiornato il primo 6 con 100 di L14: " + l14.updateFirst(6, 100).print());
      System.out.println("L14: " + l14.print());
      System.out.println("Aggiornati tutti i 6 con 100 di L14: " + l14.updateAll(6, 100).print());
