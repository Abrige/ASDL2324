...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    protected class RecBST {
        ...
        protected int computeHeight() {
            ...
            return Math.max(this.left.computeHeight(), this.right.computeHeight()) + 1;
        ...
        //nel caso pessimo la ricerca costa O(h) se l'albero
        // è anche bilanciato la ricerca costerebbe O(log n)
        ...
        protected void addLabelsInOrder(List<E> l) {
            ...
            if(this.left!=null){
                l.add(this.left.label);
                this.left.addLabelsInOrder(l);
            }
            else {
                l.add(this.right.label);
        ...
        protected List<E> inOrderVisit() {
            ...
            if(this.left != null)
                leftList = this.left.inOrderVisit();
            leftList.add(this.label);
            if(this.right != null)
                rightList = this.right.inOrderVisit();
            rightList.add(this.label);
