...
public class GraphNode<L> {
     ...
     */
    public static int COLOR_WHITE = 0; //andrebbe messo a final

    /**
     * Colore grigio associato al nodo.
     */
    public static int COLOR_GREY = 1; //andrebbe messo a final

    /**
     * Colore nero associato al nodo.
     */
    public static int COLOR_BLACK = 2; //andrebbe messo a final
