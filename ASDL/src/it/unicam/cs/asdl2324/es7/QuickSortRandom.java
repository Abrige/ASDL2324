...
public class QuickSortRandom<E extends Comparable<E>>
    ...
    private void quickSort(List<E> list, int lowIndex, int highIndex) {
        ...
        //sceglie un numero casuale per l'indice del pivot nella lista
        int pivotIndex = randomGenerator.nextInt(highIndex - lowIndex) + lowIndex;
        //come pivot prendiamo l'ultimo elemento dell'array
        E pivot = list.get(pivotIndex);
        //scambio il pivot con l'elemento in ultima posizione
        this.swap(list, pivotIndex, highIndex);
